...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Spanish translation of Laravel's default validation messages, matching
    | this project's vendor/laravel/framework validation.php key-for-key.
    | APP_LOCALE/APP_FALLBACK_LOCALE are both "es" with no lang/es directory
    | previously present, so any built-in rule without a custom Filament
    | message fell through to showing the raw "validation.max.file"-style
    | key instead of a real message — found via a photo-upload size error.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparece en una filtración de datos conocida. Elegí un :attribute diferente.',
    ],
